<?php if ( ! defined('BASEPATH')) exit('No direct script access allowed');
	class Fpelatihan extends CI_Controller{
		...
		function index(){
			$data['pelatihan'] = $this->mread->pelatihan_front();
			$data['page'] = "pelatihan_front";
			$this->load->view('admin/container', $data);
		}
		function update($id){
			$this->mupdate->pelatihan_front($id);
			redirect('admin/fpelatihan');
		}
		function delete($id){
