                  <div class="mainy">
						 <div class="row">
							...
							<div class="col-md-12">
							   <div class="awidget">
								 <div class="judul">
									<i class="icon-home"></i> Update Modul Member
								</div>
								<div class="addplus">
									<p style="color:#16cbe6;">Update Module Member</p>
								</div>
                              ...
                              <?php
									foreach ($value as $data){
										...
										$attributes = array('class' => 'form-horizontal',
											'role' =>'form');
										echo form_open_multipart('admin/membmodule/update/'.$val,$attributes);
								?>
                                ...
                                <div class="form-group">
								 ...
								 <div class="form-group">
                                  ...
                                  <div class="col-lg-9">
                                    <div style="margin-top:8px;"><a class="module" href="<?php echo base_url();?>file/modul/member/<?php echo $data->NAMA_MODULE;?>"><?php echo $data->NAMA_MODULE;?></a></div>
                                  </div>
                                </div> 
								<div class="form-group">
