							...
							<div class="col-md-12">
							   <div class="awidget">
								...
								<div class="addplus">
									...
									?>
									<p style="color:#16cbe6"> Quisioner Tutor</p>
									  ...
									  <?php
										...
										<tr>
										  ...
										  <td><?php echo $data->JUMLAH_SOAL_QUISIONER;?> Soal</td>
											...
											<td><a href="<?php echo base_url();?>admin/report/quisioner_tutor_View?id_pelatihan=<?php echo $data->ID_PELATIHAN;?>&id_quisioner=<?php echo $data->ID_QUISIONER;?>">Lihat Hasil Quisioner</a></td>
										</tr>
										<?php
											}
										?>
