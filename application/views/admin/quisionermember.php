						 ...
						 <div class="row">
							...
							<div class="col-md-12">
							   <div class="awidget">
								...
								<?php
					if($this->session->flashdata('insert_quisioner') != ''){
							echo '
							  <div class="alert alert-success">
								<button type="button" class="close" data-dismiss="alert">&times;</button>'.$this->session->flashdata('insert_quisioner').'
							  </div>
							';
						}
			?>
...
// code for IE6, IE5 
	...
	function changeFunc() {
		...
		xmlhttp.open("POST","<?php echo base_url();?>admin/quisioner/getView/"+selectedValue,false);		
		xmlhttp.send(null); 
