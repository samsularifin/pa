                              ...
                              <?php
								foreach ($hasil as $data){
									...
									$attributes = array('class' => 'form-horizontal',
										'role' =>'form');
									echo form_open('admin/pelatihan/klinikupdate/'.$val,$attributes);
								?>
                              
                                <div class="form-group">
                                  <label class="col-lg-3 control-label">Nama Pelatihan</label>
                                  <div class="col-lg-7">
                                    <input type="text" class="form-control" placeholder="masukkan nama pelatihan" name="nama_klinik" value="<?php echo $data->NAMA_PELATIHAN;?>">
                                  </div>
                                </div> 
								<div class="form-group">
                                  ...
                                  <div class="col-lg-9">
                                    <?php 
										$data2 = array('name' =>'deskripsi_klinik',
