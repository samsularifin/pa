<div class="widget">
		<div class="widget-header"> <i class="icon-bookmark"></i>
			<h3>Module Pelatihan Tutor</h3>
		</div>
	<!-- /widget-header -->
		<div class="widget-content" style="margin-bottom:50px">
		<?php
...
// code for IE6, IE5 
	...
	function changeFunc() {
		...
		xmlhttp.open("POST","<?php echo base_url();?>tutor/module/tampilkan/"+selectedValue,false);		
		xmlhttp.send(null); 
