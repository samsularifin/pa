...
<div class="widget">
	...
	<!-- /widget-header -->
		...
		<?php
			$id_quiz = 0;
		?>
			<form action="<?php echo base_url();?>member/quisioner/submit/" method="POST">
			<ol >
						<?php
								$i=0;
						...
						<div class="form-actions">
							<button type="submit" class="btn btn-primary" style="background:#62a8d9">Submit Quisioner</button>
							</div> <!-- /form-actions -->
						</form>
		</div>
		<br/><br/>
