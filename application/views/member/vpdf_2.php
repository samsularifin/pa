   ...
   $pdf->Image(base_url().'desainfront/img/1.jpg',20,11,70,0,'');  //left, height
	...
	/*  $pdf->SetFont('Arial','',09);
	  ...
	  $pdf->Ln(20);*/
		...
		$pdf->Cell(90, 10, $data->NAMA_LENGKAP, 0, 'L');
		$pdf->SetFont('Arial', '', 10);
		$pdf->Ln();
		//
		$pdf->Cell(60, 10, 'No Registrasi Pendaftaran', 0, 'L');
		$pdf->Cell(5, 10, ':', 0, 'L');
		$pdf->Cell(90, 10, $data->NMOR_IDENTITAS, 0, 'L');
		$pdf->Ln(10);
		...
		$pdf->Cell(5, 10, ':', 0, 'L');
		$pdf->SetFont('Arial','B',15);
		$pdf->Cell(90, 10, $data->NAMA_PELATIHAN, 0, 'L');
		$pdf->SetFont('Arial', '', 10);
		$pdf->Ln();
		//
		$pdf->Cell(60, 10, 'Tanggal Pelatihan', 0, 'L');
		$pdf->Cell(5, 10, ':', 0, 'L');
		$pdf->Cell(90, 10, $data->TANGGAL_PELATIHAN."-".$data->BULAN_PELATIHAN."-".$data->TAHUN_PELATIHAN, 0, 'L');
		$pdf->Ln(10);
