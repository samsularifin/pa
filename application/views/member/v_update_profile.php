		...
		<div class="widget-content" >
			<?php
						foreach($user as $data){
							?>
			<hr/>
			<form id="edit-profile" class="form-horizontal" style="margin-left:40px" action="<?php echo base_url();?>member/profile/update/<?php echo $data->ID_USER;?>" enctype="multipart/form-data" method="POST">
				<div class="fields">
						<fieldset>
							...
							<div class="control-group">											
								...
								<div class="controls">
									<input type="text" name="no_identitas" class="span4" value="<?php echo $data->NMOR_IDENTITAS;?>"/>
								</div> <!-- /controls -->				
							</div> <!-- /control-group -->
							<div class="control-group">											
							...
							<div class="control-group">	
								...
								<div class="controls">
									<input type="text" name="alamat" class="span4" value="<?php echo $data->ALAMAT;?>"/>
								</div> <!-- /controls -->				
							</div> <!-- /control-group -->
							<div class="control-group">	
								<label class="control-label" for="firstname">JENIS KELAMIN</label>
								<div class="controls">
									<input type="text" name="jenis_kelamin" class="span4" value="<?php echo $data->JENIS_KELAMIN;?>"/>
								</div> <!-- /controls -->				
							</div> <!-- /control-group -->
							<div class="control-group">											
								<label class="control-label" for="firstname">AGAMA</label>
								<div class="controls">
									<input type="text" name="agama" class="span4" value="<?php echo $data->AGAMA;?>"/>
								</div> <!-- /controls -->				
							</div> <!-- /control-group -->
							<div class="control-group">	
							...
							<div class="control-group">	
								...
								<div class="controls">
									 <select name="pekerjaan" style="width:380px;">
													<option
														<?php if($data->STATUS_PEKERJAAN =="Pelajar"){
															echo "selected='selected'";
														}?>
													value="Pelajar">PELAJAR</option>
													<option
														<?php if($data->STATUS_PEKERJAAN =="Mahasiswa"){
															echo "selected='selected'";
														}?>
														value="Mahasiswa">MAHASISWA</option>
													<option
													<?php if($data->STATUS_PEKERJAAN =="Pekerja"){
															echo "selected='selected'";
														}?>
													value="Pekerja">PEKERJA</option>
													<option <?php if($data->STATUS_PEKERJAAN =="Swasta"){
															echo "selected='selected'";
