...
<!-- BEGIN ARTICLE CONTENT AREA -->
	...
	<div class="span8 main-column three-columns-central">
		<h2 style="color:#2773ae">HALAMAN REGISTRASI MEMBER RUMAH BAHASA </h2>
									<hr/>
								...
								<?php
									$attributes = array(
										'id' =>'validForm');
									echo form_open_multipart('register/insertmember/',$attributes);
								?>
										<div class="control-group">
                                            <label class="control-label" for="inputName">NO IDENTITAS (KTP / SIM)<sup>*</sup></label>
                                            <div class="controls">
                                                <input type="text" class="span5" name="nomor_id" id="inputName" placeholder="Nomor Identitas" />
												<span class="help-inline">Silahkan masukkan nmor identitas</span>
                                            </div>
                                        </div>
                                        <div class="control-group">
										...
										<div class="control-group">
                                            <label class="control-label" for="inputEmail">AGAMA<sup>*</sup></label>
                                            <div class="controls">
                                                <input type="text" class="span5" name="agama" id="agama" placeholder="Agama" />
                                                <span class="help-inline">Silahkan masukkan Agama </span>
                                            </div>
                                        </div>
										<div class="control-group">
